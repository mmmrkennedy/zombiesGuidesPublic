...
function process_morse_code() {
    ...
    if (decodedMorseToText === "") {
        morseCodeInputError.innerText =
            "Error: Failed to decode morse code. Check your spacing between letters and words.";
        return;
    }
    ...
    if (extractedNumber === "PARTIAL") {
        killNumberSpan.innerHTML =
            '<span style="color: orange; font-weight: bold;">⚠ TWENTY or TWENTYFIVE</span> — Continue entering morse code to determine which one.';
